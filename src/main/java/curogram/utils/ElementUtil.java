...
public class ElementUtil {
	...
	public void doActionAndMove(By locator, int x, int y, int x1, int y1, int x2, int y2){
		WebElement element = getElement(locator);
		Actions act = new Actions(driver);
		Action drawAction = act.moveToElement(element, x, y)
				.clickAndHold()
				.moveByOffset(x1, y1)
				.moveByOffset(x2, y2)
				.release()
